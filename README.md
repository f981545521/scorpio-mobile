### 学习项目来自：[ddBuy](https://github.com/Geek-James/ddBuy)
...
**ddBuy**是一个移动端开源电商项目，它基于
 [vue 2.x](https://github.com/vuejs/vue) 和
 ...
 后台数据通过
 - [Easy-Mock](https://github.com/easy-mock/easy-mock) 搭建。
 
 > 支持多语言国际化,相信不管你是处于哪个段位的攻城狮，本项目都能帮助到你。
