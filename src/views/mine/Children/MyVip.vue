...
<template>
  <div id="myVip"
    ...
    <div v-if="!isShowLoading">
      ...
      <div class="vipHeader">
        <img alt=""
             src="./../../../images/mine/vip.png">
      </div>
      <div class="vipPrivilege">
        <p class="title">{{$t('mine.greenCardPower')}}</p>
        <van-grid :border=false>
          <van-grid-item :text="$t('mine.cardTip1')"
                         icon="vip-card-o"/>
          <van-grid-item :text="$t('mine.cardTip2')"
                         icon="discount"/>
          <van-grid-item :text="$t('mine.cardTip3')"
                         icon="gem-o"/>
          <van-grid-item :text="$t('mine.cardTip4')"
                         icon="more-o"/>
        </van-grid>
        <div @click="goToPayPage"
             class="becomVipBtn">{{$t('mine.fiftypecert')}}
        </div>
      </div>
      <!-- 第1部分 -->
      <div class="coupons">
      ...
      <div class="coupons">
        ...
        <div class="integralBox">
          ...
          <div class="rightBox">
            ...
            <div class="line"></div>
            <img alt=""
                 src="./../../../images/mine/rockets.png">
          </div>
        </div>
        <div @click="goToPayPage"
             class="integralToFast">{{$t('mine.cardSpecialTip')}}
        </div>
      </div>
      <!-- 第3部分 -->
      <div class="coupons">
    ...
    <transition name="fade">
      <div class="bottomJoinVip"
        ...
        <div class="bottomDesc">
          <span class="yearCart">{{$t('mine.yearCard')}}</span><i>{{$t('mine.cardPrisea')}}</i><span
                class="originPrice">{{$t('mine.cardPriseb')}}</span>
        </div>
        <div @click="goToPayPage"
             class="joinVip">
          {{$t('mine.openCards')}}
