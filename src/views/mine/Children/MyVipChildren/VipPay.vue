...
<template>
  <div id="vipPay">
    ...
    <!-- 会员类型 -->
    <div class="vipType">
      <div :class="{selected:checked,normal:!checked}"
           @click="chooseClick(1)"
           class="chooseType">
        <i>{{$t('mine.vipType')}}</i>
      ...
      <div :class="{selected:secondChecked,normal:!secondChecked}"
           @click="chooseClick(2)"
           class="chooseType">
        <i>{{$t('mine.vipType1')}}</i>
        <span class="title">{{$t('mine.vipTime1')}}</span>
        <a :checked="secondChecked"
           class="cartCheckBox"
           href="javaScript:;"></a>
    ...
    <div @click="clickPay"
         class="payButton">{{$t('mine.payImmeatally')}}
    </div>
  </div>
</template>
