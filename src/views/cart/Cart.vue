...
<template>
  <div class="cart">
    ...
    <header class="
      ...
      <div :style="selectedGoodsCount==0?'color:grey':'color:#45c763'"
           @click="clearCart"
           class="clearCart"
    ...
    <div class="cartWrapper">
      ...
      <div class="contentWrapper"
        ...
        <!-- 提交订单 -->
        <van-submit-bar :button-text="submitBarText"
                        :disabled="!(selectedGoodNum>0)"
                        :price="totalPrice"
                        @submit="onSubmit"
                        v-show="isShowEmptyCart">
          <van-checkbox checked-color='#45c763'
                        v-model="isCheckedAll">{{$t('car.all')}}
          </van-checkbox>
        </van-submit-bar>
      </div>
      <!-- 猜你喜欢 -->
