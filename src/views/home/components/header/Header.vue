 ...
 * @FilePath: /ddBuy-dev/src/views/home/components/header/Header.vue
 -->
<template>
  <div :style="showBgColor?'background-color: white;':''"
       class="wrapper">
    <div class="locationWrapper"
         ref="location">
      <svg class="icon iconLocation"
           viewBox="0 0 30 30">
        <path d="M14.521 30.445c.817.738 2.142.75 2.958 0 0 0 11.521-9.82 11.521-17.158C29 5.95 23.18 0 16 0S3 5.949 3 13.287c0 7.339 11.521 17.158 11.521 17.158zM16 18a5 5 0 1 0 0-10 5 5 0 0 0 0 10z"
              fill="#FFFFFF"
      ...
      <router-link class="address"
                   tag="span"
                   to="/dashboard/map">{{location || $t('home.chooseLocation')}}
      </router-link>
      ...
      <div class="searchContent">
        <div class="iconSearchWrapper">
          <svg class="icon iconSearch"
               viewBox="0 0 32 32">
            <path d="M23.624 21.503c3.47-4.51 3.14-11.003-.992-15.135-4.491-4.49-11.773-4.49-16.264 0-4.49 4.491-4.49 11.773 0 16.264 4.132 4.131 10.625 4.462 15.135.992l4.66 4.66a1.5 1.5 0 1 0 2.121-2.121l-4.66-4.66zm-3.114-.993A8.5 8.5 0 1 0 8.49 8.49a8.5 8.5 0 0 0 12.02 12.02z"
                  fill="#999"
                  fill-rule="evenodd"></path>
          </svg>
        </div>
