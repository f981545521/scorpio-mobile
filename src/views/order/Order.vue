...
<template>
  <div id="order">
    <van-nav-bar :fixed=true
                 ...
                 left-arrow/>
    <!-- 选择收货地址 -->
    <van-contact-card :add-text="$t('order.location')"
                      :name="address_name"
                      :tel="address_phone"
                      :type="address_type"
                      @click="chooseAddress"
    ...
    <van-cell-group>
      ...
      <TimeIntervalList :showDateTimePopView="showDateTimePopView"
                        ...
                        ref="timeInterval"></TimeIntervalList>
      <!-- 商品缩略图 -->
    ...
    <van-cell-group style="margin-top: 0.6rem">
      <van-coupon-cell :chosen-coupon="chosenCoupon"
                       :coupons="coupons"
                       @click="showList = true"/>
    ...
    <!-- 提交订单 -->
    <van-submit-bar :button-text="$t('order.sendForm')"
                    :label="$t('order.pay')"
                    :price="actualPrice"
                    @submit="onSubmit"/>
    <!-- 路由出口 -->
